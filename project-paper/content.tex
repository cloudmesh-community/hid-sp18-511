...
This module take care of different infrastructure related items like
...
master node and other machines will work as worker node. The script
expose options for Apache Spark cluster deployment, execution of
commands on Apache Spark cluster, and termination of
machines. Benchmarking is done on measuring the deployment, data
...
be done in few minutes. Two EC2 instances have been created in this
