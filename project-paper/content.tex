...
tasks on Spark Cluster. This project also does the benchmarking of deployment, data processing and termination of the instances. 
...
This module take care of different
infrastructure related items like provisioning of EC2~\cite{hid-sp18-511-www-ec2} instances,
...
allow connectivity on various ports. This module also perform
Apache Spark installation on the provisioned EC2~\cite{hid-sp18-511-www-ec2} instances using
master/worker model. One of the machine will work as a master node and
other machines will work as worker node. The script expose
options for Apache Spark cluster deployment, execution of commands on
Apache Spark cluster, and termination of machines. Benchmarking is done on measuring the deployment, data processing and termination of the instances.

Ansible~\cite{hid-sp18-511-www-ansible} automation tool
is be used in this project to provision
...
be done in few minutes. Two EC2 instances have been created in this project with following configuration 
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		Node1             & Ubuntu Server 16.04(ami-4e79ed36)	& t2.micro      & 1GB          & 1              & 8GB          \\ \hline
		Node2             & Ubuntu Server 16.04(ami-4e79ed36)	& t2.micro      & 1GB          & 1              & 8GB          \\ \hline
	\end{tabular}
\end{table}
