...
Table ~\ref{t:ec2-configuration} provides the EC2~\cite{hid-sp18-511-www-ec2} configuration details.
...
\begin{verbatim}
ansible-playbook 2.5.0 version = 2.7.13 (default, Jan 24 2018,
21:48:31) [GCC 5.4.0 20160609]
\end{verbatim}
...
\begin{verbatim}
export AWS_ACCESS_KEY_ID='<AWS_ACCESS_KEY_ID value>' export
...
\begin{verbatim}
cd ~/github/cloudmesh-community/$HID.git/project-code/roles
...
Figure~\ref{f:security-group} shows the security group created in the deployment.
...
Figure~\ref{f:key-pair} shows the security group created in the deployment.
...
Figure~\ref{f:ec2-instance} shows the security group created in the deployment.

\begin{figure}[!ht]
	\centering\includegraphics[width=\columnwidth]{images/ec2instances.png}
	\caption{Key pair}\label{f:ec2-instance}
\end{figure}
