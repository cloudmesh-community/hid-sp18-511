...
related tasks on Apache Spark Cluster. This project also does the
benchmarking of deployment, data processing and termination of the
instances. This project provide option to terminate the Apache Spark 
cluster once data processing task is completed.
...
machines will work as worker node. 

The module expose command line
...
\begin{table}[]
	\centering 
	\caption{Resource Specification} \label{t:resource-specification}
	\begin{tabular}{|lllll} 
	\toprule
	\hline
	\textbf{Instance} & \textbf{Image} & \textbf{Size} & \textbf{RAM} & \textbf{VCPUs} & \textbf{Disk} \\ 
	Spark Master & Ubuntu Server 16.04(ami-4e79ed36) & t2.micro & 1GB & 1 & 8GB \\
    Spark Worker & Ubuntu Server 16.04(ami-4e79ed36) & t2.micro & 1GB & 1 & 8GB \\     
    \hline
	\end{tabular}
\end{table}
...
\TODO{picture of directory structure}
...
\begin{verbatim}
\centering\includegraphics[width=\columnwidth]{images/security_group.png}
\end{verbatim}

\textbf{Key Pair:}

\begin{verbatim}
\centering\includegraphics[width=\columnwidth]{images/key_pair.png}
\end{verbatim}

\textbf{EC2~\cite{hid-sp18-511-www-ec2} instances:}

\begin{verbatim}
\centering\includegraphics[width=\columnwidth]{images/ec2_instances.png}
\end{verbatim}
...
\begin{verbatim}
\centering\includegraphics[width=\columnwidth]{images/spark_cluster_url.png}
\end{verbatim}
