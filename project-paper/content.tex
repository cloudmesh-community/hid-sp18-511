...
This table~\ref{t:results-table} provide the duration for deployment
of Spark~\cite{hid-sp18-511-www-spark} Cluster on two
EC2~\cite{hid-sp18-511-www-ec2} instances. Apache
Spark~\cite{hid-sp18-511-www-spark} master will be deployed on one
EC2~\cite{hid-sp18-511-www-ec2} instance and Apche
Spark~\cite{hid-sp18-511-www-spark} worker will be deployed on another
