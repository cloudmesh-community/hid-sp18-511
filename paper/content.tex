...
decision.\footnote{THis is not part of a technology abstract start with what the technology is about}
...
cloud-based systems and many more.\footnote{I do not understand what Informatica is from this description}
\ffotnote{As we do not know what informatica is we cannot classify it in a chapter}}
\end{abstract}
