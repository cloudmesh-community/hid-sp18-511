...
\begin{abstract}
There is massive of data both on-premise and cloud-based. The data has different format, volume and velocity. Every organization has
a necessity to integrate such kind of data between on-premise and cloud-based systems.
Informatica Intelligent Cloud Services (IICS) provide complete suit of integration for such kind of diverse and unique requirement.
\end{abstract}
...
capability of data integration between cloud-based and on-premise systems
